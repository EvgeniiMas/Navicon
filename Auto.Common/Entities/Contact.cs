...
namespace Auto.Common.Entities
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		/// <summary>
		/// Отображение текущего числа неудавшихся попыток ввода пароля для контакта.
		/// </summary>
		...
		/// <summary>
		/// Указание того, подтвердил ли контакт электронную почту.
		/// </summary>
		...
		/// <summary>
		/// Показывает дату и время последнего успешного входа пользователя на портал.
		/// </summary>
		...
		/// <summary>
		/// Указывает, что контакт больше не может входить на портал с использованием локальной учетной записи.
		/// </summary>
		...
		/// <summary>
		/// Указание того, будет ли этот контакт отслеживать неудавшиеся попытки доступа и будет ли включаться блокировка контакта при превышении числа неудавшихся попыток. Чтобы избежать блокировки контакта, можно отключить этот параметр.
		/// </summary>
		...
		/// <summary>
		/// Отображение момента времени, когда заблокированный контакт будет разблокирован.
		/// </summary>
		...
		/// <summary>
		/// Указание того, включена ли веб-проверка подлинности для контакта.
		/// </summary>
		...
		/// <summary>
		/// Указание того, подтвердил ли контакт номер телефона.
		/// </summary>
		...
		/// <summary>
		/// Токен, используемый для управления сеансом веб-проверки подлинности.
		/// </summary>
		...
		/// <summary>
		/// Указание того, включена ли двухфакторная проверка подлинности для контакта.
		/// </summary>
		...
		/// <summary>
		/// Отображение удостоверения пользователя для локальной веб-проверки подлинности.
		/// </summary>
		...
		/// <summary>
		/// Предпочитаемый LCID портала пользователя
		/// </summary>
		...
		/// <summary>
		/// Сведения о том, был ли контакт создан автоматически при отправке сообщения электронной почты или в результате встречи.
		/// </summary>
		...
		/// <summary>
		/// Уникальный код организации, связанной с контактом.
		/// </summary>
		...
		/// <summary>
		/// Сопоставляется с записями KPI по контактам
		/// </summary>
		...
		/// <summary>
		/// Указать влияние на покупку с помощью меток
		/// </summary>
		...
		/// <summary>
		/// Указывает, что контакт отказался от веб-отслеживания.
		/// </summary>
		...
		/// <summary>
		/// Указывает, является ли контакт помощником в организационной диаграмме
		/// </summary>
		...
		/// <summary>
		/// Указывает, что контакт считается несовершеннолетним в своей юрисдикции.
		/// </summary>
		...
		/// <summary>
		/// Указывает, что контакт считается несовершеннолетним в своей юрисдикции и получил родительское согласие.
		/// </summary>
		...
		/// <summary>
		/// Указывает дату и время, когда пользователь принял условия использования портала.
		/// </summary>
		...
		/// <summary>
		/// Предпочитаемый язык портала пользователя
		/// </summary>
		...
		public System.Nullable<Auto.Common.Entities.ContactState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Auto.Common.Entities.ContactState)(System.Enum.ToObject(typeof(Auto.Common.Entities.ContactState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		/// <summary>
		/// 1:N auto_contact_auto_agreement_contact
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("auto_contact_auto_agreement_contact")]
		public System.Collections.Generic.IEnumerable<Auto.Common.Entities.auto_agreement> auto_contact_auto_agreement_contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Auto.Common.Entities.auto_agreement>("auto_contact_auto_agreement_contact", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("auto_contact_auto_agreement_contact");
				this.SetRelatedEntities<Auto.Common.Entities.auto_agreement>("auto_contact_auto_agreement_contact", null, value);
				this.OnPropertyChanged("auto_contact_auto_agreement_contact");
			}
		}
		
		/// <summary>
		/// 1:N auto_contact_auto_communication_contactid
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("auto_contact_auto_communication_contactid")]
		public System.Collections.Generic.IEnumerable<Auto.Common.Entities.auto_communication> auto_contact_auto_communication_contactid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Auto.Common.Entities.auto_communication>("auto_contact_auto_communication_contactid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("auto_contact_auto_communication_contactid");
				this.SetRelatedEntities<Auto.Common.Entities.auto_communication>("auto_contact_auto_communication_contactid", null, value);
		...
		public System.Collections.Generic.IEnumerable<Auto.Common.Entities.Contact> Referencedcontact_customer_contacts
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Auto.Common.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Referencedcontact_customer_contacts");
				this.SetRelatedEntities<Auto.Common.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<Auto.Common.Entities.Contact> Referencedcontact_master_contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Auto.Common.Entities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Referencedcontact_master_contact");
				this.SetRelatedEntities<Auto.Common.Entities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public Auto.Common.Entities.Contact Referencingcontact_customer_contacts
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Auto.Common.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Referencingcontact_customer_contacts");
				this.SetRelatedEntity<Auto.Common.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public Auto.Common.Entities.Contact Referencingcontact_master_contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Auto.Common.Entities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Referencingcontact_master_contact");
				this.SetRelatedEntity<Auto.Common.Entities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
