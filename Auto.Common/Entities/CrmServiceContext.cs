...
namespace Auto.Common.Entities
{
	...
	public partial class CrmServiceContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="Auto.Common.Entities.auto_agreement"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Auto.Common.Entities.auto_agreement> auto_agreementSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<Auto.Common.Entities.auto_agreement>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Auto.Common.Entities.auto_auto"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Auto.Common.Entities.auto_auto> auto_autoSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<Auto.Common.Entities.auto_auto>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Auto.Common.Entities.auto_brand"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Auto.Common.Entities.auto_brand> auto_brandSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<Auto.Common.Entities.auto_brand>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Auto.Common.Entities.auto_communication"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Auto.Common.Entities.auto_communication> auto_communicationSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<Auto.Common.Entities.auto_communication>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Auto.Common.Entities.auto_credit"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Auto.Common.Entities.auto_credit> auto_creditSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<Auto.Common.Entities.auto_credit>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Auto.Common.Entities.auto_invoice"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Auto.Common.Entities.auto_invoice> auto_invoiceSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<Auto.Common.Entities.auto_invoice>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Auto.Common.Entities.auto_model"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Auto.Common.Entities.auto_model> auto_modelSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<Auto.Common.Entities.auto_model>();
			}
		}
