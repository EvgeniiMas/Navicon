...
{
    /// <summary>
    /// Операция формирования графика платежей по договору
    /// </summary>
    public sealed class AgreementGeneratingPaymentScheduleActivity : CodeActivity
    {
        /// <summary>
        /// Ссылка на договор
        /// </summary>
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            try
            {
                ...
                invoiceService.GenerateSchedule(agreementRef);
            }
            catch (Exception ex)
            {
